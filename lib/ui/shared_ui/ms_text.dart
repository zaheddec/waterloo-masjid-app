...
class MSText extends StatelessWidget {
  ...
  MSText.header(this.text, {super.key, this.textAlign, this.textColor})
      : style = header.copyWith(color: textColor);
  MSText.headerAddress(this.text, {super.key, this.textAlign, this.textColor})
      : style = headerAddress.copyWith(color: textColor);
  MSText.salahName(this.text, {super.key, this.textAlign, this.textColor})
      : style = salahName.copyWith(color: textColor);
  MSText.salahTimeLabel(this.text, {super.key, this.textAlign, this.textColor})
      : style = salahTimeLabel.copyWith(color: textColor);
  MSText.iqamahTime(this.text, {super.key, this.textAlign, this.textColor})
      : style = iqamahTime.copyWith(color: textColor);

  MSText.screenHeader(this.text, {super.key, this.textAlign, this.textColor})
      : style = screenHeader.copyWith(color: textColor);

  MSText.detailedEventHeader(this.text,
      {super.key, this.textAlign, this.textColor})
  ...
  MSText.detailEventBody(this.text, {super.key, this.textAlign, this.textColor})
